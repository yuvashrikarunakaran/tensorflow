...
absl::Status EmitGeneric(mlir::OpBuilder builder,
  ...
  EmitterLocOpBuilder b(loc, builder,
                        root->GetModule()
                            ->config()
                            .debug_options()
                            .xla_gpu_annotate_with_emitter_loc());
...
std::string DumpTritonIR(mlir::ModuleOp triton_module, bool align_annotations) {
...
absl::StatusOr<mlir::OwningOpRef<mlir::ModuleOp>> CreateTritonModule(
  ...
  EmitterLocOpBuilder b(loc, &mlir_context,
                        debug_options.xla_gpu_annotate_with_emitter_loc());
